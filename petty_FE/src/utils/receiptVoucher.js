 ...
 */
export const getReceiptVoucherKhos = async () => {
  try {
 ...
 */
export const getReceiptVoucherKho = async (id) => {
  try {
...
/**
 * Alias cho getReceiptVoucherKho - lấy chi tiết phiếu nhập kho
 */
export const getChiTietReceiptVoucherKho = getReceiptVoucherKho;

/**
 * Tạo phiếu nhập kho mới
 */
export const createReceiptVoucherKho = async (data) => {
  try {
 ...
 * Xóa phiếu nhập kho
 */
export const deleteReceiptVoucherKho = async (id) => {
  try {
 ...
 */
export const exportReceiptVoucherKhoPdf = async (id) => {
  try {
