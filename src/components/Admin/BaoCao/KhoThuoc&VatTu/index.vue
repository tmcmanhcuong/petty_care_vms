<template>
  <div class="font-nunitoSans bg-gray-50 p-6">
    <!-- Header -->
    <div class="mb-6">
      <h1 class="text-4xl font-bold text-gray-900 mb-1">Báo cáo Kho & Vật tư</h1>
      <p class="text-sm text-gray-600">Phân tích tài chính kho hàng và tối ưu hóa luân chuyển</p>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
      <div class="flex items-center justify-between gap-4">
        <!-- Month Filter -->
        <button class="flex items-center justify-between px-3 py-2 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors flex-1 max-w-md">
        ...
        <button class="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors">
          <img :src="iconExport" alt="" class="w-4 h-4" />
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        <div class="flex items-start justify-between mb-6">
          ...
          <div class="w-12 h-12 bg-teal-100 rounded-lg flex items-center justify-center">
            <img :src="iconInventory" alt="" class="w-6 h-6" />
          </div>
        </div>
        <div class="mb-2">
      ...
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        <div class="flex items-start justify-between mb-6">
          ...
          <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
            <img :src="iconImport" alt="" class="w-6 h-6" />
          </div>
        </div>
        <div class="mb-2">
      ...
      <div class="bg-white rounded-xl border-2 border-red-200 p-6">
        <div class="flex items-start justify-between mb-6">
          ...
          <div class="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center">
            <img :src="iconLoss" alt="" class="w-6 h-6" />
          </div>
        </div>
        <div class="mb-2">
      ...
      <div class="col-span-2 bg-white rounded-xl border border-gray-200 p-6">
        <div class="mb-4">
          <div class="flex items-center gap-2 mb-2">
            <img :src="iconChart" alt="" class="w-5 h-5" />
            <h3 class="text-base font-normal text-gray-900">Biểu đồ Biến động Kho</h3>
          </div>
          <p class="text-sm text-gray-600">So sánh Nhập - Xuất bán - Hủy theo thời gian</p>
        </div>
        
        <!-- Chart Placeholder -->
        <div class="h-72 mb-4 flex items-center justify-center bg-gray-50 rounded">
          <img :src="chartImage" alt="Biểu đồ" class="max-w-full max-h-full" />
        </div>
        ...
        <div class="flex items-center justify-center gap-6 mb-4">
          <div class="flex items-center gap-2">
            ...
            <span class="text-xs text-gray-600">🟥 Xuất hủy</span>
          </div>
          <div class="flex items-center gap-2">
            <div class="w-3 h-3 bg-blue-500 rounded-sm"></div>
            <span class="text-xs text-gray-600">🟦 Nhập kho</span>
          </div>
          <div class="flex items-center gap-2">
            <div class="w-3 h-3 bg-green-500 rounded-sm"></div>
            <span class="text-xs text-gray-600">🟩 Xuất bán</span>
          </div>
        </div>
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-3">
          <div class="flex items-start gap-2">
            <img :src="iconInfo" alt="" class="w-4 h-4 mt-0.5" />
            <div>
          ...
          <div class="relative w-40 h-40">
            <svg viewBox="0 0 100 100" class="transform -rotate-90">
              ...
              <circle cx="50" cy="50" r="40" fill="none" stroke="#14b8a6" stroke-width="20" 
                      stroke-dasharray="125.6 251.2" stroke-dashoffset="0" />
              <!-- Thuốc 30% -->
              <circle cx="50" cy="50" r="40" fill="none" stroke="#3b82f6" stroke-width="20" 
                      stroke-dasharray="75.36 251.2" stroke-dashoffset="-125.6" />
              <!-- Thức ăn 12% -->
              <circle cx="50" cy="50" r="40" fill="none" stroke="#8b5cf6" stroke-width="20" 
                      stroke-dasharray="30.144 251.2" stroke-dashoffset="-200.96" />
              <!-- Vật tư 6% -->
              <circle cx="50" cy="50" r="40" fill="none" stroke="#f59e0b" stroke-width="20" 
                      stroke-dasharray="15.072 251.2" stroke-dashoffset="-231.104" />
              <!-- Khác 2% -->
              <circle cx="50" cy="50" r="40" fill="none" stroke="#10b981" stroke-width="20" 
                      stroke-dasharray="5.024 251.2" stroke-dashoffset="-246.176" />
            </svg>
          </div>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
      <div class="mb-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <h3 class="text-base font-normal text-gray-900">Top Hàng Bán Chạy & Lợi nhuận</h3>
        </div>
        ...
        <table class="w-full">
          <thead>
            <tr class="border-b border-gray-200">
              ...
              <th class="text-right text-sm text-gray-600 font-normal py-3 px-2">Số lượng bán</th>
              <th class="text-right text-sm text-gray-600 font-normal py-3 px-2">Doanh thu</th>
              <th class="text-right text-sm text-gray-600 font-normal py-3 px-2">Lợi nhuận gộp</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="item in topSellingItems" :key="item.id" class="border-b border-gray-100 hover:bg-gray-50">
              <td class="py-4 px-2">
                <div class="flex items-center gap-2">
                  <span class="inline-block bg-amber-100 text-amber-800 text-xs font-medium px-2 py-1 rounded">
                    {{ item.rank }}
                  </span>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-4">
        <p class="text-xs text-blue-900">
          💡 <span class="font-bold">Action:</span> Nhập số lượng lớn để được chiết khấu tốt hơn từ nhà cung cấp
        </p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
      <div class="mb-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <h3 class="text-base font-normal text-gray-900">Hàng Chậm luân chuyển (Dead Stock)</h3>
        </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tbody>
            <tr v-for="item in deadStockItems" :key="item.id" class="border-b border-gray-100 hover:bg-gray-50">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
      <div class="mb-4">
        <div class="flex items-center gap-2 mb-2">
          ...
          <h3 class="text-base font-normal text-gray-900">Cảnh báo Cận Date (Expiring Soon)</h3>
        </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tbody>
            <tr v-for="item in expiringItems" :key="item.id" class="border-b border-gray-100 hover:bg-gray-50">
              <td class="py-3 px-2 text-sm text-gray-900">{{ item.name }}</td>
              <td class="py-3 px-2">
                <span class="inline-block bg-gray-100 text-gray-700 text-xs px-2 py-1 rounded font-mono">
                  {{ item.lotNumber }}
                </span>
              </td>
              <td class="py-3 px-2">
              ...
              <td class="py-3 px-2 text-right">
                <span :class="[
                  ...
                  item.urgent ? 'bg-red-100 text-red-700' : 'bg-orange-100 text-orange-700'
                ]">
                  {{ item.status }}
                </span>
              </td>
      ...
      <div class="mt-4 space-y-3">
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-3">
          <p class="text-xs text-red-900 mb-2">🔴 <span class="font-bold">Action Matrix:</span></p>
          <div class="space-y-1 text-xs text-red-900">
            <p><span class="font-bold">&lt; 7 ngày:</span> Flash sale 50% OFF | Chương trình từ thiện | Báo huỷ NCC</p>
            <p><span class="font-bold">7-30 ngày:</span> Bundle promotion | Ưu tiên gợi ý cho khách | Bày trưng bày nổi bật</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="flex-1 space-y-6">
          ...
          <div>
            <p class="text-sm text-gray-900 mb-2">
              💡 <span class="font-bold">Logic tính Giá trị Hủy/Hao hụt (Loss Value):</span>
            </p>
            <div class="bg-gray-100 rounded px-2 py-1 mb-2">
              <code class="text-xs text-gray-800">Loss Value = Σ (Hàng hết hạn + Vỡ + Hỏng + Chênh lệch kiểm kê)</code>
            </div>
            <p class="text-xs text-gray-700">
              <span class="font-bold">Example:</span> Vắc-xin hết hạn 3M + Thuốc vỡ 1.5M + Chênh lệch kiểm kê 1M = <span class="font-bold">5.5M Loss</span>
            </p>
          </div>

          <!-- Alert Thresholds -->
          <div>
            <p class="text-sm text-gray-900 mb-2">📊 <span class="font-bold">Alert Thresholds:</span></p>
            <ul class="space-y-1 text-xs text-gray-700">
              <li>• ✓ &lt;1% of inventory value: Normal (Current: 0.44%)</li>
              <li>• ⚠️ 1-3%: Need attention</li>
          ...
          <div>
            <p class="text-sm text-gray-900 mb-2">🔄 <span class="font-bold">Dead Stock Definition:</span></p>
            <p class="text-xs text-gray-700">Hàng nhập &gt; 90 ngày, bán &lt; 10% số lượng → Vốn bị "chôn" không sinh lời</p>
          </div>

          <!-- FIFO Rule -->
          <div>
            <p class="text-sm text-gray-900 mb-2">📅 <span class="font-bold">FIFO Rule (First In First Out):</span></p>
            <p class="text-xs text-gray-700">Luôn xuất hàng nhập trước để giảm thiểu loss. Kiểm tra date khi xuất kho</p>
          </div>
        </div>
      </div>
    </div>
...
// Icons from Figma
const iconChevronDown = 'https://www.figma.com/api/mcp/asset/2ec93300-57ad-4337-8707-244920c76d1c';
const iconExport = 'https://www.figma.com/api/mcp/asset/61a5eebe-6cf8-4b4a-965a-8f6e0c2fec7b';
const iconInventory = 'https://www.figma.com/api/mcp/asset/a050a96f-f2fd-428d-bc98-afbe51c3c86d';
const iconImport = 'https://www.figma.com/api/mcp/asset/490e80d7-059b-4bae-a94c-91364a974e17';
const iconLoss = 'https://www.figma.com/api/mcp/asset/45f43398-4ecb-41d8-a522-04b7d1df62b0';
const iconChart = 'https://www.figma.com/api/mcp/asset/76698a6a-779d-43a9-97b4-316996ac6138';
const iconInfo = 'https://www.figma.com/api/mcp/asset/496c2fca-1d6f-41fd-8e33-9df4b5e5b991';
const iconTrending = 'https://www.figma.com/api/mcp/asset/76698a6a-779d-43a9-97b4-316996ac6138';
const iconAlert = 'https://www.figma.com/api/mcp/asset/76698a6a-779d-43a9-97b4-316996ac6138';
const iconWarning = 'https://www.figma.com/api/mcp/asset/496c2fca-1d6f-41fd-8e33-9df4b5e5b991';
const iconCalendar = 'https://www.figma.com/api/mcp/asset/2ec93300-57ad-4337-8707-244920c76d1c';
const chartImage = 'https://www.figma.com/api/mcp/asset/22809b7a-1e4a-4de0-9c8b-8c41aa841e4e';
