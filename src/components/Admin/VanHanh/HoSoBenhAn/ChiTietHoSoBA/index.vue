<template>
  <div class="flex flex-col gap-6">
    ...
    <button
      @click="$emit('back')"
      class="bg-white border border-black/10 rounded-lg h-9 px-[13px] mb-0 w-fit flex items-center gap-2 hover:bg-gray-50 transition-colors"
    >
    ...
    <div class="bg-white border border-black/10 rounded-[14px] p-6">
      <div class="flex items-start justify-between mb-4">
        ...
        <div class="flex gap-4">
          <img :src="patient.image" :alt="patient.name" class="w-24 h-24 rounded-full object-cover" />
        ...
        <div class="flex flex-col items-end gap-2">
          ...
          <div class="flex items-center gap-2">
            ...
            <a :href="'tel:' + patient.phone" class="font-nunito text-sm leading-5 text-[#009689] hover:underline">
              {{ patient.phone }}
            </a>
          </div>
          <div class="flex items-center gap-2">
