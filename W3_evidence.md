...
> **Notes:** Thử kết nối trực tiếp vào RDS endpoint từ máy local — bị timeout/refused vì RDS không có public IP và DB Security Group không có inbound rule từ `0.0.0.0/0`. Defense-in-depth: ngay cả khi biết endpoint, không thể kết nối từ ngoài VPC.
